...
public class Exam0210 {
  ...
  void m1(Object value) {System.out.printf("value=%s\n", value);}
  //모든객체를 받을 수 있다
  //만약에 wrapper클래스가 없다면 다음과같이
  //정수를 받는 메서드와 부동소수점을 받는메서드
  //논리값을 받는 메서드를 따로따로 정의해야한다
  //이런불편함을 없애기 위해 wrapper클래스르 만든것이다
  void m2(long value) {System.out.printf("value=%s\n", value);} //byte, short,int,long,char
  void m3(double value) {System.out.printf("value=%s\n", value);} //float, double
  void m3(boolean value) {System.out.printf("value=%s\n", value);}//boolean
