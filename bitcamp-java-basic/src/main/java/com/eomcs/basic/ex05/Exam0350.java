...
// 보통 천연색을 표현하기 위해 RGB 각 색상을 8비트로 표현한다. (빛의 세기를 비트연산으로 표현)
...
//비트 연산 활용 예2:
//=흑백을 반전시키자
//=> 방법: 빛이있는 점은 빛을 없에고(1>>0) 빛이 잇는점은 빛을 넣는다(0>>1)
...
//-------------------------------
// 1111111 11111111 11111111 (변견한 색 흰색)


//비트 연산 활용 예4: 
//특정 색상만 제거하기 
//방법
//^ 연산자를 사용하여 특정색상만 제거할수 있다
//다음과 같이비트 데이터가 있다
//=> 다음과 같이 한 개의 점이 있다.

//11001010 11100100 00111001 (예제 색상)
//11111111 11111111 11111111(제거하려는 색상)
//-------------------------------
//00000000 000000000 00000000 (필터)
//한점에대해 연산한 출력결과가 0이면 해당점의 색상을 정하고
//만약 0이 아니먄 원래색상을 그대로 적용한다
